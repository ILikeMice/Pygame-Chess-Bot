...
square_size = 600//8
bb,bk,bn,bp,bq,br,wb,wk,wn,wp,wq,wr = [pygame.transform.scale(pygame.image.load(f"{piece}.png"), (square_size, square_size)) for piece in ["bb","bk","bn","bp","bq","br","wb","wk","wn","wp","wq","wr"]]
